...
function showAbout() {
  return showInfoBox(
    <>
      ...
      <p>
        和泉民國國語推導工具（下稱「本頁面」）由{" "}
        <a target="_blank" rel="noreferrer" href="https://github.com/ConcerroX">
          ConcerroX
        </a>{" "}基於切韻音系自動推導器開發。切韻音系自動推導器開發由{" "}
        <a target="_blank" rel="noreferrer" href="https://nk2028.shn.hk/">
          nk2028
        </a>{" "}開發，基於 MIT 協議開源。
      </p>
      <p>
        <a target="_blank" rel="noreferrer" href="https://github.com/ConcerroX/tshet-uinh-autoderiver">
          本頁面源代碼
        </a>
        公開於 GitHub。
      </p>
...
function showHelp() {
  return showInfoBox(
    <>
      ...
      {/*  </li>*/}
      {/*  <li>*/}
      {/*    <kbd>Esc</kbd> (<kbd>⎋</kbd>)：關閉「推導結果」面板*/}
      {/*  </li>*/}
      {/*</ul>*/}
      {/*<p>此外，推導方案檔案亦可透過拖曳載入。</p>*/}
      <h3>指定個別字音</h3>
      <p>
        推導文章時，若某字有多個音，則該字會被著色，點擊可選擇想要的字音。
      </p>
      {/*<p>*/}
